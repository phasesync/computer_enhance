...
extern "C"
{
    __declspec(dllimport) u32 Sim86_GetVersion(void);
    __declspec(dllimport) void Sim86_Decode8086Instruction(u32 SourceSize, u8 *Source, instruction *Dest);
    __declspec(dllimport) char const *Sim86_RegisterNameFromOperand(register_access *RegAccess);
    __declspec(dllimport) char const *Sim86_MnemonicFromOperationType(operation_type Type);
    __declspec(dllimport) void Sim86_Get8086InstructionTable(instruction_table *Dest);
}
